...
class ProductApi {
    async getProductsList() {
        ...
        if (!response.ok) {
            throw new Error(
                `ProductApi: getProductsList failed, HTTP status ${response.status}`
            );
        }
    ...
    async createProduct(newProduct) {
        ...
        if (!response.ok) {
            throw new Error(
                `ProductApi: createProduct failed, HTTP status ${response.status}`
            );
        }
    ...
    async getProduct(productID) {
        ...
        if (!response.ok) {
            throw new Error(
                `ProductApi: displayProduct failed, HTTP status ${response.status}`
            );
        }
    ...
    async deleteProduct(productID) {
        ...
        if (!response.ok) {
            throw new Error(
                `ProductApi: deleteProduct failed, HTTP status ${response.status}`
            );
        }

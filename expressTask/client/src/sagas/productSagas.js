...
function* loadProductList() {
    try {
        ...
        yield put({
            type: ACTION_TYPES.GET_PRODUCT_LIST_SUCCESS,
            payload: resData
        });
    } catch (e) {
        yield put({
            type: ACTION_TYPES.GET_PRODUCT_LIST_FAILURE,
            message: e.message
        });
    }
}
...
function* loadProduct(action) {
    try {
        ...
        yield put({
            type: ACTION_TYPES.GET_PRODUCT_FAILURE,
            message: e.message
        });
    }
}
...
function* filterList(action) {
    try {
        ...
        yield put({
            type: ACTION_TYPES.FILTER_PRODUCT_SUCCESS,
            payload: resData
        });
    } catch (e) {
        yield put({
            type: ACTION_TYPES.PRODUCT_FILTER_FAILURE,
            message: e.message
        });
    }
}
